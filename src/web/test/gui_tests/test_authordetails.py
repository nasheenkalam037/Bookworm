...
class AuthorDetailsTest(unittest.TestCase):
    ...
    def test_authordetails(self):
        ...
        elem = self.driver.find_element_by_xpath("//img[contains(@src,'499.jpeg')]")
        if elem.size != 0:
            pass
        else:
    ...
    def bookDeals(self):
        ...
        elem = self.driver.find_element_by_xpath("//a[contains (@href,'https://www.amazon.ca/Horus-Heresy-First-Heretic/dp/1844168859/')]")
